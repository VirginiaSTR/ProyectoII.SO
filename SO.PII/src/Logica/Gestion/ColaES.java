...
/**
 * Clase ColaES (Cola de Entrada/Salida).
 *
 * Implementa una estructura de datos de tipo cola (FIFO) utilizando una lista enlazada
 * interna. Su función principal es servir como buffer para todas las SolicitudesES
 * pendientes que el PlanificadorDisco debe procesar.
 *
